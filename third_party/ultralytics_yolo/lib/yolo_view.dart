...
class _YOLOViewState extends State<YOLOView> {
  ...
  /// inference (sub-plan 3 step 1). See [YOLOViewController.startRecording].
  Future<void> startRecording(String path) =>
      _effectiveController.startRecording(path);

  /// Stops the current recording, if any. See
  /// [YOLOViewController.stopRecording].
  Future<void> stopRecording() => _effectiveController.stopRecording();
}
